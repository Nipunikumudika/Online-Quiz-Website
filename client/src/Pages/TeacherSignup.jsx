...
function TeacherSignup() {
    ...
    const handleCreateTeacher = async (event) => {
      const postURL = "http://localhost:5000/teachers";
    ...
    <div className="background" style={{ backgroundImage: `url(${img1})` }}>
      ...
      <center>
        ...
        <p className="welcome" style={{ fontSize: 30 ,marginTop:-20}}>
          ...
          >
            <p style={{fontSize:50,color:"#F4DF25",fontWeight:500}}>Teacher SignUp</p>
            <img style={{margin:0}} className="img" src={require("../Images/teacher.png") } />




            <form  onSubmit={handleCreateTeacher} style={{ margin: "auto" }}>
